        ...
        <div className="relative card-premium p-6 overflow-visible">
          ...
          <div className="flex items-start justify-between mb-6 relative">
            <div className="flex items-center gap-3">
              ...
              <img src="/valoroxoro.svg" alt="Valorox" style={{ width: 40, height: 40, borderRadius: '50%', border: '1.5px solid rgba(240,180,41,0.35)', objectFit: 'cover', objectPosition: 'top center' }} />
              <div>
