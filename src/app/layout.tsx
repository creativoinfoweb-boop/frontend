...
export const metadata: Metadata = {
  ...
  description: 'Valorox: trading automatizzato su XAU/USD gestito da un sistema multiagent AI — scalping, intraday, analisi volumetrica, CRT. Esecuzione automatica sull\'oro con intelligenza artificiale, risk management avanzato e dashboard in tempo reale. Trial gratuito 5 giorni.',
  keywords: [
    ...
    'multiagent AI trading', 'trading automatico oro', 'gold trading intelligenza artificiale',
    'XAU/USD', 'trading oro', 'MetaTrader 5', 'trading automatico MT5',
    'sistema trading automatizzato', 'trading automatizzato Italia',
  ...
  openGraph: {
    title: 'Valorox AI Trading System | Trading XAU/USD con Multiagent AI',
    description: 'Trading automatizzato su oro (XAU/USD) gestito da multiagent AI. Esecuzione sistematica, risk management professionale, dashboard in tempo reale. Trial 5 giorni gratis.',
    type: 'website',
    locale: 'it_IT',
    url: SITE_URL,
    siteName: 'Valorox',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Valorox AI Trading System — Trading automatizzato su XAU/USD con Multiagent AI',
        type: 'image/png',
      },
    ],
  },
...
const websiteSchema = {
  ...
  description: 'Sistema di trading automatizzato su XAU/USD gestito da multiagent AI.',
...
const softwareSchema = {
  ...
  url: SITE_URL,
  description: 'Piattaforma di trading automatizzato su XAU/USD gestita da multiagent AI. Esecuzione automatica sull\'oro tramite MetaTrader 5, risk management avanzato e dashboard in tempo reale.',
  screenshot: `${SITE_URL}/og-image.png`,
  featureList: [
    'Trading automatizzato su XAU/USD con multiagent AI',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Valorox è un sistema di trading automatizzato su XAU/USD (oro) gestito da multiagent AI. Unisce intelligenza artificiale e metodo Smart Money per eseguire operazioni in modo sistematico, senza interferenza emotiva. Non è un servizio di consulenza finanziaria.',
      },
    },
    {
      '@type': 'Question',
