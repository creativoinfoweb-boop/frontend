      ...
      <nav className="fixed top-0 w-full z-50 transition-all duration-500 mt-[2px]"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <span className="text-base font-semibold" style={{ fontFamily: 'var(--font-orbitron)', letterSpacing: '0.12em', background: 'linear-gradient(135deg, var(--gold-dark), var(--gold), var(--gold-dark))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Valorox</span>
            ...
            {[
              ...
              <div key={i} className="card-premium p-6 text-center relative">
                <div className="absolute top-4 right-4 text-5xl font-black opacity-[0.04]"
                  style={{ color: 'var(--gold)', fontFamily: 'var(--font-orbitron)' }}>
                  {item.step}
                </div>
